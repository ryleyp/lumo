...
- The mobile Update app button clears only Lumo's app-file cache, preserves saved filters in browser storage, checks GitHub Pages for fresh files, activates the newest service worker, and reloads.
